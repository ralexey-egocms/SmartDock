        ...
        public MvxCommand OnLoginCommand
        {
            get
            {
                return new MvxCommand(async () =>
                {
                    ...
                    {
                        _currentStateService.CurrentUser = await _webService.LogIn(Login, Password);

                        if (_currentStateService.CurrentUser != null &&
                            _currentStateService.CurrentUser.IsValid)
                        {
                            Error = String.Empty;
